...
public class MatrixDoubleCalculator extends MatrixCalculator<Double> {

    public MatrixDoubleCalculator(String filename, int test_size, OperationName operationName) {
        ...
        switch (operationName) {
            ...
            case CIRCLE_POINT:
                this.operation = (pair) -> {
                    int line = pair.getKey();
                    int column = pair.getValue();
                    return 1/(1/matrix1.getElement(line,column)+1/matrix2.getElement(line,column));
                };
        }
    }
